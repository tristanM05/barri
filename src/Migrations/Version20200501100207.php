 ...
 */
final class Version20200501100207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stock_client CHANGE quantity quantity INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE salepoint CHANGE visible visible TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE stock_client CHANGE quantity quantity NUMERIC(10, 2) NOT NULL');
        $this->addSql('ALTER TABLE user_configuration CHANGE maxsupertop maxsupertop INT DEFAULT NULL, CHANGE maxtop maxtop INT DEFAULT NULL');
    }
}
