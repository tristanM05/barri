 ...
 */
final class Version20200401123938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD isconnected TINYINT(1) NOT NULL, CHANGE isadmin isadmin TINYINT(1) DEFAULT NULL, CHANGE activation_token activation_token VARCHAR(50) DEFAULT NULL, CHANGE reset_token reset_token VARCHAR(50) DEFAULT NULL');
