 ...
 */
final class Version20200326083632 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE subfamily (id INT AUTO_INCREMENT NOT NULL, family_id INT NOT NULL, client_id INT NOT NULL, wording VARCHAR(50) NOT NULL, INDEX IDX_C39AA97EC35E566A (family_id), INDEX IDX_C39AA97E19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE subfamily ADD CONSTRAINT FK_C39AA97EC35E566A FOREIGN KEY (family_id) REFERENCES family (id)');
        $this->addSql('ALTER TABLE subfamily ADD CONSTRAINT FK_C39AA97E19EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
